			...
			<div class="col-sm-4">
				<ul class="list-group" style="padding-top: 25px;">
					...
					<li class="list-group-item list-group-item-primary"><a
						class="list-item" href="#">美食饕餮</a></li>
					<li class="list-group-item list-group-item-light"><a
						class="list-item"
						href="${pageContext.request.contextPath}/home?action=note">浮生游记</a></li>
					<li class="list-group-item list-group-item-light"><a
						class="list-item" href="${pageContext.request.contextPath }/home?action=release">发布游记</a></li>
				</ul>
			</div>
			<div class="col-sm-8">
				<c:forEach var="delicacy" items="${delicacyList }">
					<div class="card" style="width: 800px">
						<div class="card-body">
							<h4 class="card-title">${delicacy.delicacyName}</h4>
							<span>价格:</span>
							<p class="card-text">${delicacy.delicacyPrice }</p>
							<span>发布时间:</span>
							<p class="card-text">${delicacy.gmtCreate }</p>
							<button type="button" class="btn btn-primary"
								data-toggle="collapse" data-target="#demo">查看美食介绍</button>
							<div id="demo" class="collapse">${delicacy.delicacyIntroduction }</div>
						</div>
						<img class="card-img-bottom"
							src="${pageContext.request.contextPath }${delicacy.delicacyImage}"
